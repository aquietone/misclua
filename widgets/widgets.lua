...
---@param posY? number #The Y cursor position to draw at
---@return string #The new or unchanged selected value of the combo box
function widgets.ComboBoxLeftText(label, id, resultVar, options, bykey, helpText, width, posX, posY)
    imgui.SetCursorPosX(posX or imgui.GetCursorPosX())
    imgui.SetCursorPosY((posY or imgui.GetCursorPosY()) + 5)
    imgui.Text(label)
    imgui.SameLine()
...
---@param posY? number #The Y cursor position to draw at
---@return boolean #The new or unchanged value of the checkbox
function widgets.CheckBoxLeftLabel(label, id, resultVar, helpText, posX, posY)
    imgui.SetCursorPosX(posX or imgui.GetCursorPosX())
    imgui.SetCursorPosY((posY or imgui.GetCursorPosY()) + 5)
    if resultVar then
...
---@param posY? number #The Y cursor position to draw at
---@return number #The new or unchanged value of the slider int
function widgets.SliderIntLeftLabel(label, id, resultVar, helpText, minValue, maxValue, width, posX, posY)
    imgui.SetCursorPosX(posX or imgui.GetCursorPosX())
    imgui.SetCursorPosY((posY or imgui.GetCursorPosY()) + 5)
    imgui.Text(label)
    imgui.SameLine()
...
---@param posY? number #The Y cursor position to draw at
---@return number #The new or unchanged value of the input int
function widgets.InputIntLeftLabel(label, id, resultVar, helpText, width, posX, posY)
    imgui.SetCursorPosX(posX or imgui.GetCursorPosX())
    imgui.SetCursorPosY((posY or imgui.GetCursorPosY()) + 5)
    imgui.Text(label)
    imgui.SameLine()
...
---@param posY? number #The Y cursor position to draw at
---@return string #The new or unchanged value of the input text
function widgets.InputTextLeftLabel(label, id, resultVar, helpText, width, posX, posY)
    imgui.SetCursorPosX(posX or imgui.GetCursorPosX())
    imgui.SetCursorPosY((posY or imgui.GetCursorPosY()) + 5)
    imgui.Text(label)
    imgui.SameLine()
